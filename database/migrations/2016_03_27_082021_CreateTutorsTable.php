...
class CreateTutorsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tutors', function (Blueprint $table) {
            ...
            $table->date('dateTo', 'Y')->nullable()->comment('Anyo en la que un profesor deja de ser tutor de un ciclo');
            $table->date('dateFrom', 'Y')->comment('Anyo en la que un profesor empieza como tutor');
