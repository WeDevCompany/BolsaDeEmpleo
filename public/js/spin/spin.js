 ...
 */
			...
			if (typeof type == "undefined" || typeof variable == "undefined"){
				...
				switch(type) {
				    ...
				    case 'C':
				        ...
				        break;
				    case 'N':
				        spinnerN = new Spinner(optsN).spin(target);
				        break;
				    case 'S':
	...
	// Variables para el spin de notificaciones
	var optsN = {
		lines: 15 // Lineas dibujadas
		, length: 15 // Longitud de la linea
		, width: 10 // Anchura de las lineas
		...
		, fps: 20 // Frames per second when using setTimeout() as a fallback for CSS
		, zIndex: 2e9 // The z-index (defaults to 2000000000)
		, className: 'spinnerN' // Nombre de la clase a la que se asignara el spinner
		, top: '50%' // Posicion relativa TOP
		, left: '50%' // Posicion relativa LEFT
		, shadow: false // Sombra
		, hwaccel: false // Whether to use hardware acceleration
	...
	var optsS = {
		...
		, fps: 20 // Frames per second when using setTimeout() as a fallback for CSS
		, zIndex: 2e9 // The z-index (defaults to 2000000000)
		, className: 'spinnerS' // Nombre de la clase a la que se asignara el spinner
		, top: '50%' // Posicion relativa TOP
		, left: '50%' // Posicion relativa LEFT
		, shadow: false // Sombra
		, hwaccel: false // Whether to use hardware acceleration
