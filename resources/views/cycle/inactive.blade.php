            ...
            <div class="panel panel-default animated zoomIn">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4><i class="fa fa-university"></i>Ciclos inactivos</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        {{ Form::close() }}
                        {{ Form::open(['url' => 'administrador/configuracion/ciclo-inactivo/restaurar', 'method' => 'POST']) }}
                            {!! csrf_field() !!}
                            <div class="scroll">
                                @include('partials.table.tableCycleInactiveList')
                            </div>
