<!-- Modal -->
<div class="modal fade" id="createWorkCenter" tabindex="-1" role="dialog" aria-labelledby="createWorkCenter" aria-hidden="true">
    <div class="modal-dialog" role="document">
        {{ Form::open(['url' => \Auth::user()->rol . '/centro/crear', 'method' => 'post', 'id' => 'enterprise-register-form']) }}
            <!--Content-->
