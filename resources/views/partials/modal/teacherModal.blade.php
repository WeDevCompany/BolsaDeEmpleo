<!-- Modal -->
<div class="modal fade" id="teacherModal{{ $teacher->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        {{ Form::open(['url' => 'administrador/profesor/rolToTeacher/' . $teacher->id, 'method' => 'POST']) }}
            {!! csrf_field() !!}
            <!--Content-->
            <div class="modal-content border-orange">
                ...
                <div class="modal-header text-center no-padding-bottom">
                    ...
                    <h4 class="modal-title titleTag" id="myModalLabel">Cambiar Rol a Profesor</h4>
                </div>
                <!--Body-->
                <div class="modal-body text-center">
                    ¿Desea cambiar el rol del administrador {{ $teacher->fullName }} a profesor?
                </div>
                <!--Footer-->
