<!-- Modal -->
<div class="modal fade" id="createProfFamily" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        {{ Form::open(['url' => config('routes.admin.profFamiliesCreate'), 'method' => 'POST']) }}
            {!! csrf_field() !!}
            <!--Content-->
            <div class="modal-content border-orange">
                ...
                <div class="modal-header text-center no-padding-bottom">
                    ...
                    <h4 class="modal-title titleTag" id="myModalLabel">Nueava familia profesional</h4>
                </div>
                <!--Body-->
