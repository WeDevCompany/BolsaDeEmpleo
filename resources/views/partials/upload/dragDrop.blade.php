        ...
        <div class="col-md-12">
            ...
            <a id="file-select">
                <div class="drop" id="drop">
                    <img id="show" class="hide-dragDrop" src="">
            ...
            <span class="alert alert-info hide-dragDrop" id="file-info">No hay archivo aún</span>
            {{ Form::file('file', ['id' => 'imagen-dragDrop'], null) }}
