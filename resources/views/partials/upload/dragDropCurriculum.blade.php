        ...
        <div class="col-md-12">
            ...
            <a id="file-select">
                <div class="drop" id="drop-curriculum">
                    <img id="show" class="hide-dragDrop" src="{{ url('/img/global/Pdf-icon.png') }}">
            ...
            <span class="alert alert-info hide-dragDrop" id="curriculum-info">No hay archivo aún</span>
            {{ Form::file('curriculum', ['id' => 'curriculum-dragDrop'], null) }}
