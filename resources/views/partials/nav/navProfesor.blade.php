...
<li class = "dropdown">
    ...
    <ul class="dropdown-menu" role="menu"  aria-labelledby="notificaciones">
        ...
        <li><a href="{{ url(config('routes.teacher.offertNotification')) }}"><i class="fa fa-university right"  aria-hidden="true"></i><span class="badge social-counter right notificacion">5</span> Profesores</a></li>
    </ul>
</a></li>
<li class = "dropdown">
    <a href="#" class="dropdown-toggle subrayado " data-toggle="dropdown" role="button" aria-expanded="false">
    ...
    <ul class="dropdown-menu" role="menu"  aria-labelledby="alumnos">
        <li><a href="{{ url(config('routes.registro.registroEstudiante')) }}"><i class="fa fa-users right" aria-hidden="true"></i> Todos</a></li>
