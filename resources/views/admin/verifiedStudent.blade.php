            ...
            <div class="panel panel-default">
                <div class="modal-content">
                    ...
                    <div class="panel-body">
                        {{ Form::open(['url' =>'admin/estudiante/verificados-buscador', 'method' => 'POST', 'class' => 'navbar-form navbar-left pull-right', 'role' => 'search', 'id' => 'search-form']) }}
                            {!! csrf_field() !!}
                        ...
                        {{ Form::close() }}
                        @include('admin.partials.tableVerifiedStudent')
