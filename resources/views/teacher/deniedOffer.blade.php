            ...
            <div class="panel panel-default">
                <div class="modal-content">
                    ...
                    <div class="panel-body">
                        {{ Form::open(['url' =>'profesor/oferta/denegadas-buscador', 'method' => 'POST', 'class' => 'navbar-form navbar-left pull-right', 'role' => 'search', 'id' => 'search-form']) }}
                            {!! csrf_field() !!}
                        ...
                        {{ Form::close() }}
                        {{ Form::open(['url' => 'profesor/oferta/restaurar', 'method' => 'POST']) }}
                            {!! csrf_field() !!}
