            ...
            <div class="panel panel-default">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4><i class="fa fa-graduation-cap"></i>Validar Ofertas de Trabajo en la Aplicacion</h4>
                    </div>
                    <div class="panel-body">
                        {{ Form::open(['url' =>'profesor/notificaciones/ofertas-buscador', 'method' => 'POST', 'class' => 'navbar-form navbar-left pull-right', 'role' => 'search', 'id' => 'search-form']) }}
